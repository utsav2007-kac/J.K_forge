                        ...
                        <div class="absolute left-0 top-24 w-full bg-white shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border-t-2 border-secondary">
                            <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="industries.html?page=automotive-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Automotive Forging</a></li>
                                        <li><a href="industries.html?page=automobile-parts" class="text-sm text-gray-700 hover:text-secondary transition-colors">Automobile Parts</a></li>
                                        <li><a href="industries.html?page=automotive-forging-rajkot" class="text-sm text-gray-700 hover:text-secondary transition-colors">Automotive Forging Rajkot</a></li>
                                        <li><a href="industries.html?page=commercial-vehicle" class="text-sm text-gray-700 hover:text-secondary transition-colors">Commercial Vehicle</a></li>
                                        <li><a href="industries.html?page=truck-parts-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Truck Parts Forging</a></li>
                                        <li><a href="industries.html?page=two-wheeler-parts" class="text-sm text-gray-700 hover:text-secondary transition-colors">Two-Wheeler Parts</a></li>
                                        <li><a href="industries.html?page=agricultural-equipment" class="text-sm text-gray-700 hover:text-secondary transition-colors">Agricultural Equipment</a></li>
                                        <li><a href="industries.html?page=tractor-parts" class="text-sm text-gray-700 hover:text-secondary transition-colors">Tractor Parts</a></li>
                                        <li><a href="industries.html?page=railway-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Railway Forging</a></li>
                                        <li><a href="industries.html?page=defense-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Defense Forging</a></li>
                                        <li><a href="industries.html?page=marine-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Marine Forging</a></li>
                                        <li><a href="industries.html?page=shipbuilding-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Shipbuilding Forging</a></li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="industries.html?page=oil-gas-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Oil & Gas Forging</a></li>
                                        <li><a href="industries.html?page=oil-gas-equipment" class="text-sm text-gray-700 hover:text-secondary transition-colors">Oil & Gas Equipment</a></li>
                                        <li><a href="industries.html?page=petrochemical-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Petrochemical Forging</a></li>
                                        <li><a href="industries.html?page=offshore-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Offshore Forging</a></li>
                                        <li><a href="industries.html?page=power-generation" class="text-sm text-gray-700 hover:text-secondary transition-colors">Power Generation</a></li>
                                        <li><a href="industries.html?page=wind-energy-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Wind Energy Forging</a></li>
                                        <li><a href="industries.html?page=solar-energy-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Solar Energy Forging</a></li>
                                        <li><a href="industries.html?page=mining-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Mining Forging</a></li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="industries.html?page=chemical-plant-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Chemical Plant Forging</a></li>
                                        <li><a href="industries.html?page=water-treatment" class="text-sm text-gray-700 hover:text-secondary transition-colors">Water Treatment</a></li>
                                        <li><a href="industries.html?page=food-processing" class="text-sm text-gray-700 hover:text-secondary transition-colors">Food Processing</a></li>
                                        <li><a href="industries.html?page=pharmaceutical-equipment" class="text-sm text-gray-700 hover:text-secondary transition-colors">Pharmaceutical Equipment</a></li>
                                        <li><a href="industries.html?page=aerospace-grade" class="text-sm text-gray-700 hover:text-secondary transition-colors">Aerospace Grade</a></li>
                                        <li><a href="industries.html?page=earthmoving-equipment" class="text-sm text-gray-700 hover:text-secondary transition-colors">Earthmoving Equipment</a></li>
                                        <li><a href="industries.html?page=construction-equipment" class="text-sm text-gray-700 hover:text-secondary transition-colors">Construction Equipment</a></li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="industries.html?page=steel-plant-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Steel Plant Forging</a></li>
                                        <li><a href="industries.html?page=cement-plant-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Cement Plant Forging</a></li>
                                        <li><a href="industries.html?page=sugar-mill-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Sugar Mill Forging</a></li>
                                        <li><a href="industries.html?page=paper-mill-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Paper Mill Forging</a></li>
                                        <li><a href="industries.html?page=textile-machinery" class="text-sm text-gray-700 hover:text-secondary transition-colors">Textile Machinery</a></li>
                                        <li><a href="industries.html?page=industrial-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Industrial Forging</a></li>
                                        <li><a href="industries.html?page=elevator-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Elevator Forging</a></li>
                                        <li><a href="industries.html?page=crane-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Crane Forging</a></li>
                                    </ul>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        ...
                                        <li><a href="capabilities.html?page=crankshaft-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Crankshaft Forging</a></li>
                                        <li><a href="capabilities.html?page=camshaft-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Camshaft Forging</a></li>
                                        ...
                                        <li><a href="capabilities.html?page=gearbox-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Gearbox Forging</a></li>
                                        ...
                                        <li><a href="industries.html?page=steel-shaft" class="text-sm text-gray-700 hover:text-secondary transition-colors">Steel Shaft</a></li>
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        ...
                                        <li><a href="product-detail.html?page=forged-fasteners" class="text-sm text-gray-700 hover:text-secondary transition-colors">Forged Fasteners</a></li>
                            ...
                            <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        ...
                                        <li><a href="product-detail.html?page=closed-die-manufacturer" class="text-sm text-gray-700 hover:text-secondary transition-colors">Closed Die Manufacturer</a></li>
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="industries.html?page=alloy-steel-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Alloy Steel Forging</a></li>
                                        <li><a href="industries.html?page=carbon-steel-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Carbon Steel Forging</a></li>
                                        <li><a href="industries.html?page=stainless-steel" class="text-sm text-gray-700 hover:text-secondary transition-colors">Stainless Steel</a></li>
                                        ...
                                        <li><a href="industries.html?page=en24-steel" class="text-sm text-gray-700 hover:text-secondary transition-colors">EN24 Steel</a></li>
                                        <li><a href="industries.html?page=en8-steel" class="text-sm text-gray-700 hover:text-secondary transition-colors">EN8 Steel</a></li>
                                        <li><a href="industries.html?page=sae-4140-steel" class="text-sm text-gray-700 hover:text-secondary transition-colors">SAE 4140 Steel</a></li>
                                        ...
                                        <li><a href="industries.html?page=spring-steel" class="text-sm text-gray-700 hover:text-secondary transition-colors">Spring Steel</a></li>
                                        <li><a href="industries.html?page=tool-steel" class="text-sm text-gray-700 hover:text-secondary transition-colors">Tool Steel</a></li>
                                        <li><a href="industries.html?page=duplex-steel" class="text-sm text-gray-700 hover:text-secondary transition-colors">Duplex Steel</a></li>
                        ...
                        <div class="absolute left-0 top-24 w-full bg-white shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border-t-2 border-secondary">
                            <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="capabilities.html?page=forging-rajkot" class="text-sm text-gray-700 hover:text-secondary transition-colors">Forging Rajkot</a></li>
                                        <li><a href="industries.html?page=steel-forging-rajkot" class="text-sm text-gray-700 hover:text-secondary transition-colors">Steel Forging Rajkot</a></li>
                                        <li><a href="capabilities.html?page=forging-shapar-rajkot" class="text-sm text-gray-700 hover:text-secondary transition-colors">Forging Shapar Rajkot</a></li>
                                        <li><a href="capabilities.html?page=forging-company-gujarat" class="text-sm text-gray-700 hover:text-secondary transition-colors">Forging Company Gujarat</a></li>
                                        <li><a href="locations.html?page=ahmedabad" class="text-sm text-gray-700 hover:text-secondary transition-colors">Ahmedabad</a></li>
                                        <li><a href="locations.html?page=surat" class="text-sm text-gray-700 hover:text-secondary transition-colors">Surat</a></li>
                                        <li><a href="locations.html?page=vadodara" class="text-sm text-gray-700 hover:text-secondary transition-colors">Vadodara</a></li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="locations.html?page=mumbai" class="text-sm text-gray-700 hover:text-secondary transition-colors">Mumbai</a></li>
                                        <li><a href="locations.html?page=pune" class="text-sm text-gray-700 hover:text-secondary transition-colors">Pune</a></li>
                                        <li><a href="locations.html?page=aurangabad" class="text-sm text-gray-700 hover:text-secondary transition-colors">Aurangabad</a></li>
                                        <li><a href="locations.html?page=nagpur" class="text-sm text-gray-700 hover:text-secondary transition-colors">Nagpur</a></li>
                                        <li><a href="locations.html?page=jaipur" class="text-sm text-gray-700 hover:text-secondary transition-colors">Jaipur</a></li>
                                        <li><a href="locations.html?page=ludhiana" class="text-sm text-gray-700 hover:text-secondary transition-colors">Ludhiana</a></li>
                                        <li><a href="locations.html?page=delhi" class="text-sm text-gray-700 hover:text-secondary transition-colors">Delhi</a></li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="locations.html?page=bangalore" class="text-sm text-gray-700 hover:text-secondary transition-colors">Bangalore</a></li>
                                        <li><a href="locations.html?page=chennai" class="text-sm text-gray-700 hover:text-secondary transition-colors">Chennai</a></li>
                                        <li><a href="locations.html?page=coimbatore" class="text-sm text-gray-700 hover:text-secondary transition-colors">Coimbatore</a></li>
                                        <li><a href="locations.html?page=hyderabad" class="text-sm text-gray-700 hover:text-secondary transition-colors">Hyderabad</a></li>
                                        <li><a href="locations.html?page=kolkata" class="text-sm text-gray-700 hover:text-secondary transition-colors">Kolkata</a></li>
                                        <li><a href="capabilities.html?page=pan-india-forging" class="text-sm text-gray-700 hover:text-secondary transition-colors">Pan India Forging</a></li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="space-y-4">
                                        <li><a href="capabilities.html?page=exporter-gujarat" class="text-sm text-gray-700 hover:text-secondary transition-colors">Exporter Gujarat</a></li>
                                        <li><a href="capabilities.html?page=exporter-india" class="text-sm text-gray-700 hover:text-secondary transition-colors">Exporter India</a></li>
                                        <li><a href="locations.html?page=supplier-india" class="text-sm text-gray-700 hover:text-secondary transition-colors">Supplier India</a></li>
                                        <li><a href="locations.html?page=supplier-uae" class="text-sm text-gray-700 hover:text-secondary transition-colors">Supplier UAE</a></li>
                                        <li><a href="locations.html?page=supplier-europe" class="text-sm text-gray-700 hover:text-secondary transition-colors">Supplier Europe</a></li>
                                    </ul>
                                </div>
                                </div>
                            </div>
            ...
            <div class="px-4 pt-2 pb-6 space-y-1" id="mobile-menu-container">
                ...
                <details class="group border-b border-gray-100 last:border-0">
                    ...
                    <div class="text-neutral-600 px-4 pb-4">
                        ...
                        <a href="industries.html?page=automotive-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Automotive Forging</a>
                        <a href="industries.html?page=automobile-parts" class="block py-2 text-sm text-gray-600 hover:text-secondary">Automobile Parts</a>
                        <a href="industries.html?page=automotive-forging-rajkot" class="block py-2 text-sm text-gray-600 hover:text-secondary">Automotive Forging Rajkot</a>
                        <a href="industries.html?page=commercial-vehicle" class="block py-2 text-sm text-gray-600 hover:text-secondary">Commercial Vehicle</a>
                        <a href="industries.html?page=truck-parts-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Truck Parts Forging</a>
                        <a href="industries.html?page=two-wheeler-parts" class="block py-2 text-sm text-gray-600 hover:text-secondary">Two-Wheeler Parts</a>
                        <a href="industries.html?page=agricultural-equipment" class="block py-2 text-sm text-gray-600 hover:text-secondary">Agricultural Equipment</a>
                        <a href="industries.html?page=tractor-parts" class="block py-2 text-sm text-gray-600 hover:text-secondary">Tractor Parts</a>
                        <a href="industries.html?page=railway-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Railway Forging</a>
                        <a href="industries.html?page=defense-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Defense Forging</a>
                        <a href="industries.html?page=marine-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Marine Forging</a>
                        <a href="industries.html?page=shipbuilding-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Shipbuilding Forging</a>
                        
                        <h4 class="text-[#c8321e] font-bold text-xs uppercase tracking-widest mt-6 mb-2">ENERGY & MINING</h4>
                        <a href="industries.html?page=oil-gas-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Oil & Gas Forging</a>
                        <a href="industries.html?page=oil-gas-equipment" class="block py-2 text-sm text-gray-600 hover:text-secondary">Oil & Gas Equipment</a>
                        <a href="industries.html?page=petrochemical-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Petrochemical Forging</a>
                        <a href="industries.html?page=offshore-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Offshore Forging</a>
                        <a href="industries.html?page=power-generation" class="block py-2 text-sm text-gray-600 hover:text-secondary">Power Generation</a>
                        <a href="industries.html?page=wind-energy-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Wind Energy Forging</a>
                        <a href="industries.html?page=solar-energy-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Solar Energy Forging</a>
                        <a href="industries.html?page=mining-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Mining Forging</a>
                        
                        <h4 class="text-[#c8321e] font-bold text-xs uppercase tracking-widest mt-6 mb-2">PROCESS INDUSTRY</h4>
                        <a href="industries.html?page=chemical-plant-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Chemical Plant Forging</a>
                        <a href="industries.html?page=water-treatment" class="block py-2 text-sm text-gray-600 hover:text-secondary">Water Treatment</a>
                        <a href="industries.html?page=food-processing" class="block py-2 text-sm text-gray-600 hover:text-secondary">Food Processing</a>
                        <a href="industries.html?page=pharmaceutical-equipment" class="block py-2 text-sm text-gray-600 hover:text-secondary">Pharmaceutical Equipment</a>
                        <a href="industries.html?page=aerospace-grade" class="block py-2 text-sm text-gray-600 hover:text-secondary">Aerospace Grade</a>
                        <a href="industries.html?page=earthmoving-equipment" class="block py-2 text-sm text-gray-600 hover:text-secondary">Earthmoving Equipment</a>
                        <a href="industries.html?page=construction-equipment" class="block py-2 text-sm text-gray-600 hover:text-secondary">Construction Equipment</a>
                        
                        <h4 class="text-[#c8321e] font-bold text-xs uppercase tracking-widest mt-6 mb-2">HEAVY INDUSTRY</h4>
                        <a href="industries.html?page=steel-plant-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Steel Plant Forging</a>
                        <a href="industries.html?page=cement-plant-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Cement Plant Forging</a>
                        <a href="industries.html?page=sugar-mill-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Sugar Mill Forging</a>
                        <a href="industries.html?page=paper-mill-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Paper Mill Forging</a>
                        <a href="industries.html?page=textile-machinery" class="block py-2 text-sm text-gray-600 hover:text-secondary">Textile Machinery</a>
                        <a href="industries.html?page=industrial-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Industrial Forging</a>
                        <a href="industries.html?page=elevator-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Elevator Forging</a>
                        <a href="industries.html?page=crane-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Crane Forging</a>
                    </div>
                </details>
                ...
                <details class="group border-b border-gray-100 last:border-0">
                    ...
                    <div class="text-neutral-600 px-4 pb-4">
                        ...
                        <a href="capabilities.html?page=crankshaft-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Crankshaft Forging</a>
                ...
                <details class="group border-b border-gray-100 last:border-0">
                    ...
                    <div class="text-neutral-600 px-4 pb-4">
                        ...
                        <a href="industries.html?page=alloy-steel-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Alloy Steel Forging</a>
                        <a href="industries.html?page=carbon-steel-forging" class="block py-2 text-sm text-gray-600 hover:text-secondary">Carbon Steel Forging</a>
                        <a href="industries.html?page=stainless-steel" class="block py-2 text-sm text-gray-600 hover:text-secondary">Stainless Steel</a>
                    </div>
                </details>
                ...
                <details class="group border-b border-gray-100 last:border-0">
                    ...
                    <div class="text-neutral-600 px-4 pb-4">
                        ...
                        <a href="capabilities.html?page=forging-rajkot" class="block py-2 text-sm text-gray-600 hover:text-secondary">Rajkot</a>
                        <a href="locations.html?page=ahmedabad" class="block py-2 text-sm text-gray-600 hover:text-secondary">Ahmedabad</a>
                        <a href="locations.html?page=surat" class="block py-2 text-sm text-gray-600 hover:text-secondary">Surat</a>
                        <h4 class="text-[#c8321e] font-bold text-xs uppercase tracking-widest mt-4 mb-2">WEST & NORTH INDIA</h4>
                        <a href="locations.html?page=mumbai" class="block py-2 text-sm text-gray-600 hover:text-secondary">Mumbai</a>
                        <a href="locations.html?page=pune" class="block py-2 text-sm text-gray-600 hover:text-secondary">Pune</a>
                        <a href="locations.html?page=delhi" class="block py-2 text-sm text-gray-600 hover:text-secondary">Delhi</a>
                        <h4 class="text-[#c8321e] font-bold text-xs uppercase tracking-widest mt-4 mb-2">SOUTH & EAST INDIA</h4>
                        <a href="locations.html?page=bangalore" class="block py-2 text-sm text-gray-600 hover:text-secondary">Bangalore</a>
                        <a href="locations.html?page=chennai" class="block py-2 text-sm text-gray-600 hover:text-secondary">Chennai</a>
                        <h4 class="text-[#c8321e] font-bold text-xs uppercase tracking-widest mt-4 mb-2">EXPORT MARKETS</h4>
                        <a href="capabilities.html?page=exporter-india" class="block py-2 text-sm text-gray-600 hover:text-secondary">Exporter India</a>
                        <a href="locations.html?page=supplier-uae" class="block py-2 text-sm text-gray-600 hover:text-secondary">Supplier UAE</a>
                    </div>
                </details>
